export const SYSTEM_PROMPT = `
    ...
    DO NOT MAKE UP TRANSCRIPTS. IF NOT RELEVANT, RETURN THE REQUIRED JSON OBJECT WITH hint: [], fillerCount: 0, newTopic: false, AND offTopic: false. NEVER RETURN NULL.
